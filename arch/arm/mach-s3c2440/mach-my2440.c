/* linux/arch/arm/mach-s3c2440/mach-my2440.c
 *
...
static struct map_desc my2440_iodesc[] __initdata = {
...
static struct s3c2410_uartcfg my2440_uartcfgs[] __initdata = {
	[0] = {
		.hwport	     = 0,
		.flags	     = 0,
		.ucon	     = 0x3c5,
...
static void __init my2440_map_io(void)
{
	s3c24xx_init_io(my2440_iodesc, ARRAY_SIZE(my2440_iodesc));
	s3c24xx_init_clocks(12000000);
	s3c24xx_init_uarts(my2440_uartcfgs, ARRAY_SIZE(my2440_uartcfgs));
}
